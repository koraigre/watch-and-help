...
if __name__ == '__main__':
    ...
    args.record_dir_alice = '../test_results/alice_hp_results'
    ...
    record_dirs = [
       ...
       '../test_results/alice_hp_results',
       '../test_results/bob_hp_predgoal_results',
       '../test_results/bob_hp_randomgoal_results',
       '../test_results/bob_randomactions_results',
       '../test_results/bob_hp_truegoal_results',
    ...
    for record_dir in record_dirs:
        ...
        test_results = pickle.load(open(record_dir + '/results_{}.pik'.format(0), 'rb'))
        ...
        SRO, ALO, SWSO, stdRO, stdLO, stdSO = get_metrics_reward(alice_results, test_results, episode_ids)
        ...
        for task_name in task_names:
            ...
            SR, AL, SWS, stdR, stdL, stdS = get_metrics_reward(alice_results, test_results, episode_ids_task)
        ...
        with open('results_mcts_across_seeds_all_baselines_reward.json', 'w+') as f:
            f.write(json.dumps(final_results, indent=3))
